namespace Models.Factories
{
    ...
    {
        private static readonly string[] CssValues =
            { "@font-face", "@keyframes", "@media", "align-content", "align-items", "align-self",
            "all", "animation", "animation-delay", "animation-direction", "animation-duration",
            ...
            "font-variant", "font-weight", "hanging-punctuation", "height", "justify-content", "left",
            ...
            "margin-top", "max-height", "max-width", "min-height", "min-width", "nav-down",
            "nav-index", "nav-left", "nav-right", "nav-up", "opacity", "order", "outline",
            ...
            "perspective-origin", "position", "quotes", "resize", "right", "table-layout", "tab-size",
            ...
            "transition-property", "transition-timing-function", "unicode-bidi", "user-select",
            "vertical-align", "visibility", "white-space", "width", "word-break", "word-spacing",
            "word-wrap", "z-index" };

        public static string GetCssPropertyString(CssPropertyType type)
        {
            var propertyIndex = (int)Enum.Parse(typeof(CssPropertyType), type.ToString());
            return CssValues[propertyIndex];
        }
    }
}